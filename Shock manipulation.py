...
final_shock = combine(N2_shock_copy,N2_pre_shock,box_param=N2_shock_copy.box,offset_x=pre_shock_req)
...
N2_shock = read_data("N2_Shock/data/shock_Ti_100_400ps.moldata")
N2_equilib = read_data("N2_Shock/data/large_equilib_900x900x1000.moldata")
N2_post_shock = read_data("N2_Shock/data/large_post-shock_900x900x2000.moldata")

trim(N2_equilib,N2_shock.box.ylo,N2_shock.box.yhi,dir='y',offset=2)
trim(N2_equilib,N2_shock.box.zlo,N2_shock.box.zhi,dir='z',offset=2)
trim(N2_post_shock,N2_shock.box.ylo,N2_shock.box.yhi,dir='y',offset=2)
trim(N2_post_shock,N2_shock.box.zlo,N2_shock.box.zhi,dir='z',offset=2)
...
post_shock_req = 3000
post_shock_insert = 19400
post_shock_delete = [21000,23500]
post_shock_req_i = ceil(post_shock_req/post_shock_width)
print('Copy post-shock:',post_shock_req_i)
...
N2_shock = delete_section(N2_shock,post_shock_delete[0],post_shock_delete[1])
print(N2_shock.box)
...
for i in range(1,post_shock_req_i):
    ...
    append_shock = deepcopy(N2_post_shock)
    trim(append_shock,append_shock.box.xlo,append_shock.box.xhi,offset=2)
    translate(append_shock,i*post_shock_width,0,0)

    N2_post_shock_copy=combine(N2_post_shock_copy,append_shock,box_param=N2_post_shock.box,offset_x=post_shock_width)
...
write_data(final_shock,'N2_Shock/data/shock_ready_Ti_100_400ps.moldata')